...
#| output: False
library(tidyverse)
black_foot_fish <- read_csv(here::here("datasets", "BlackfootFish.csv"))
```
...
```{r}
#| output: False
rescale_02(black_foot_fish$length)

black_foot_fish_new <- black_foot_fish |> 
  mutate(rescaled_length = rescale_02(length))
```
