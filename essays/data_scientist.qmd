...
I have grown tremendously as a data scientist in this class this quarter. My main takeaway from this class is that I have learned how to think like a data scientist in general. Coding is quite literally another language that one must understand fundamentally in order to successfully write code. I have grown in the sense that it is much easier for me to manipulate data using filtering, selecting, and grouping variables to achieve what I want. This area of growth is represented throughout my labs and assignments, but is especially reflected in the last lab we completed, Lab 9. In Lab 9, I was able to use filtering, grouping, and mutating functions within one pipeline operator seamlessly. This can be shown in #1 in part 3, as well as throughout the rest of the lab. 
